...
import { baseNumberIndex, baseNumberFromIndex } from "./baseNumber.js"

export const isElemental = (members, i) => {
...
export function picaFromDDC(concept) {
  ...
  const pica = ["045H", "20", "e", "DDC23ger", "a", concept.notation[0]]
  ...
  pica.push("c", baseNumberFromIndex(members, i))
